...
def myNetwork():
    ...
    info('*** Add routers\n')
    r1 = net.addHost('r1', cls=Host, ip=None)
    r2 = net.addHost('r2', cls=Host, ip=None)
    r3 = net.addHost('r3', cls=Host, ip=None)
    r4 = net.addHost('r4', cls=Host, ip=None)
    r5 = net.addHost('r5', cls=Host, ip=None)
    r6 = net.addHost('r6', cls=Host, ip=None)
    ...
    h1 = net.addHost('h1', cls=Host, ip='10.1.1.1/24', defaultRoute='10.10.1.1/24')
    h2 = net.addHost('h2', cls=Host, ip='10.2.2.1/24', defaultRoute='10.10.2.1/24')
    h3 = net.addHost('h3', cls=Host, ip='10.3.3.1/24', defaultRoute='10.10.3.1/24')
    h4 = net.addHost('h4', cls=Host, ip='10.4.4.1/24', defaultRoute='10.10.4.1/24')
    h5 = net.addHost('h5', cls=Host, ip='10.5.5.1/24', defaultRoute='10.10.5.1/24')
    h6 = net.addHost('h6', cls=Host, ip='10.6.6.1/24', defaultRoute='10.10.6.1/24')
